      ...
      try {
        ...
        if (clientsRes.ok && servicesRes.ok) {
          ...
          setStats({
            ...
            pendingServices: services.filter((s: any) => s.estado === SERVICE_STATES.PENDING).length,
            completedServices: services.filter((s: any) => s.estado === SERVICE_STATES.COMPLETED).length,
            waitingPartServices: services.filter((s: any) => s.estado === SERVICE_STATES.WAITING_PART).length,
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 pr-4">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <Badge className={`${SERVICE_STATE_COLORS[service.estado]} text-xs flex-shrink-0`}>
                                <div className="flex items-center gap-1">
                                  {getStateIcon(service.estado)}
                                  {SERVICE_STATE_LABELS[service.estado]}
                                </div>
                              </Badge>
                            </div>
